...
// WarpError The Warp9 protocol expresses an error as a int16 value with negative values representing framework
...
// Object server implementations generating errors must use this type.
...
// ErrorCode create a new W9Err instance.
func ErrorCode(code int16) *WarpError {
	return &WarpError{code, ""}
}

// ErrorMsg create a new W9Err instance with an optional msg.
...
// Implement the standard string interface. Call Error().
func (e *WarpError) String() string {
	return e.Error()
}

// Equals compares this WarpError to 'errcode'
func (e *WarpError) Equals(errcode int16) bool {
	return e.errcode == errcode
}

func (e *WarpError) IsFWError() bool {
	return e.errcode <= Egood
}

// WarpErrorEOF end of object Data. alias of io.EOF
var WarpErrorEOF = &WarpError{Eeof, ""}

// WarpErrorNOTEXIST object not exist
...
func init() {
	...
	ErrStr[Eeof*-1] = "obj: EOF: end of data"
	...
	ErrStr[Ebufsmall*-1] = "obj: buf too small"
